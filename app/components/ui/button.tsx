...
const buttonVariants = cva(
  "cursor-pointer shadow-[0_4px_0_0] active:shadow-none active:translate-y-1 border-transparent inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border-foreground/80 shadow-foreground/80 hover:bg-foreground/5",
        secondary:
          "text-secondary-foreground bg-secondary shadow-secondary-dark hover:bg-secondary-light",
        ghost:
          "border-transparent shadow-transparent hover:shadow-muted hover:border-muted",
