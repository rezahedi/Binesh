...
export type RadioQuiz = {options: string[]; answer: number};
...
export type CheckListQuiz = {options: string[]; answer: number[]};
...
export type FillQuiz = {inputType: string; answer: string; content: string};
